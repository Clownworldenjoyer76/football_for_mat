...
READS:
    ...
    docs/win/football/prop_engine/data/current/{season}_week_1_roles.parquet
    docs/win/football/prop_engine/data/current/features/{season}_week_1_features.parquet
    configured historical player-game universe
    configured historical player-game feature table (prior-season team reference)

WRITES:
    docs/win/football/prop_engine/data/current/{season}_week_1_priors.parquet
    docs/win/football/prop_engine/logs/week1_priors_{season}.json
