...
AUDIT_REL = Path("docs/win/football/prop_engine/evaluation/model_selection_predictions.parquet")
REPORT_LOG_REL = Path("docs/win/football/prop_engine/logs/model_performance_report.json")
