...
READS
    ...
    docs/win/football/prop_engine/models/{target}/selected_model.json
    configured historical feature table

WRITES
    docs/win/football/prop_engine/models/calibration/{target}_calibration.json
...
CALIBRATION_ROOT = Path(
    "docs/win/football/prop_engine/models/calibration"
)
