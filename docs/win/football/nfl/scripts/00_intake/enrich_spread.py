...
validate_master = _enrichment_partial(
    ...
    header_label="spread enrichment master",
    display_name="Spread",
    ...
    metric_fields=("historical_cover_rate_pct", "lift_vs_family_pct_points", "games"),
    fail=fail,
)
match_rules = _enrichment_partial(
    _enrichment_match_rules_side,
    master_label="spread",
    rate_source_field="historical_cover_rate_pct",
    rate_output_field="historical_cover_rate_pct",
    fail=fail,
)
build_summary_fields = _enrichment_partial(
    _enrichment_build_side_summary_fields,
    rate_key="historical_cover_rate_pct",
    rate_suffix="hist_cover_rate_pct",
)
