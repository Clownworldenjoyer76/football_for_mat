...
```text
docs/win/football/prop_engine/models/components/{component_name}/
docs/win/football/prop_engine/models/efficiency/{model_name}/
docs/win/football/prop_engine/models/{target}/
docs/win/football/prop_engine/models/calibration/
```
