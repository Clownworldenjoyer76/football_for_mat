...
BASELINE_PATH = (
    "docs/win/football/prop_engine/evaluation/baseline_oof_predictions.parquet"
)
ELIGIBILITY_PATH = (
...
SELECTION_OUTPUT = (
    "docs/win/football/prop_engine/evaluation/model_selection.csv"
)
AUDIT_OUTPUT = (
...
def score_direct_variants(
    ...
    metadata = load_json(root / "docs/win/football/prop_engine/models" / target / "metadata.json")
...
def score_opportunity_models(
    ...
    for component in opportunity.COMPONENT_ORDER:
        ...
        metadata = load_json(
            root
            / "docs/win/football/prop_engine/models/components"
            / component
            / "metadata.json"
        )
...
def score_efficiency_models(
    ...
    for model_name in efficiency.MODELS:
        ...
        metadata = load_json(
            root
            / "docs/win/football/prop_engine/models/efficiency"
            / model_name
            / "metadata.json"
        )
