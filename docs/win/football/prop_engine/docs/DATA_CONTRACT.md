...
`docs/win/football/prop_engine/data/current/source/`
...
| Dataset | Path |
|---|---|
| Identity crosswalk | `docs/win/football/prop_engine/data/identity/player_crosswalk.parquet` |
| Historical universe | `docs/win/football/prop_engine/data/historical/universe/player_game_universe.parquet` |
| Historical targets | `docs/win/football/prop_engine/data/historical/targets/player_game_targets.parquet` |
| Player opportunity | `docs/win/football/prop_engine/data/historical/opportunity/player_week_opportunity.parquet` |
| Team opportunity | `docs/win/football/prop_engine/data/historical/opportunity/team_week_opportunity.parquet` |
...
`docs/win/football/prop_engine/data/current/features/`

Models are rooted at:

`docs/win/football/prop_engine/models/`

Evaluation artifacts are rooted at:

`docs/win/football/prop_engine/evaluation/`

Production outputs are rooted at:

`docs/win/football/prop_engine/output/`

Run logs are rooted at:

`docs/win/football/prop_engine/logs/`
...
`docs/win/football/prop_engine/scripts/build/build_targets.py`
